			...
			return array(
				...
				'fields' => array(
					...
					array(
  					...
  					array(
	  					'id' => 'style:#mfn-sidemenu-tmpl-postid .mfn-sidemenu-tmpl-builder:justify-content_laptop',
	  					'type' => 'radio_img',
	  					'alias' => 'sidemenu_content_position',
	  					'responsive' => 'laptop',
	  					'title' => __('Content position', 'mfn-opts'),
		...
		public function list_tabs_wrapper($actions) {
			...
			<ul class="mfn-template-filters">
				...
				<li class="mfn-template-filter-dropdown">
					<a href="?post_type=template&tab=blog" class="nav-tab mfn-label-nav-tab mfn-label-blog <?php if($tab==='blog'):?>nav-tab-active<?php endif; ?>">Blog <span class="mfn-label-counter"><?php echo (count($blogs)+count($posts)); ?></span> <span class="mfn-icon mfn-icon-arrow-down"></span></a>
					<ul>
						<li><a href="?post_type=template&tab=blog" class="nav-tab mfn-label-nav-tab mfn-label-blog <?php if($tab==='blog'):?>nav-tab-active<?php endif; ?>">Archive <span class="mfn-label-counter"><?php echo count($blogs); ?></span></a></li>
				...
				<li class="mfn-template-filter-dropdown">
					<a href="?post_type=template&tab=portfolio" class="nav-tab mfn-label-nav-tab mfn-label-portfolio <?php if($tab==='blog'):?>nav-tab-active<?php endif; ?>">Portfolio <span class="mfn-label-counter"><?php echo (count($portfolios)+count($singleportfolios)); ?></span> <span class="mfn-icon mfn-icon-arrow-down"></span></a>
					<ul>
						<li><a href="?post_type=template&tab=portfolio" class="nav-tab mfn-label-nav-tab mfn-label-portfolio <?php if($tab==='blog'):?>nav-tab-active<?php endif; ?>">Archive <span class="mfn-label-counter"><?php echo count($portfolios); ?></span></a></li>
