        ...
        <div class="form-content form-content-full-width">
            <div class="form-group">
                <div class="form-control" style="">
                        ...
                        <p class="hint">Only builder content will be imported. Does not import archives. Single pages and posts only. Theme options, sliders and images will not be imported.</p>
